...
///////// INFORMACIÓN WIFI //////////
const char* ssid = "Home-69"; // EDITAR PARA LA RED LOCAL A LA CUAL SE VAYA A CONECTAR EL ESP8266 ///
const char* password = "Tilin666#"; ///****************************************///
...
const int LED1 = 16; // pin de salida          ///// EDITAR SEGÚN LOS PINES UTILIZADOS EN LA TECNOLOGIA DE IRONMAN SON LOS 12,14,02,16  ////////////////////
const int LED2 = 2; // pin de salida
const int LED3 = 14; // pin de salida
const int LED4 = 12; // pin de salida
int wait = 1000;
...
String outputState4 = "apagado"; //almacenar el estado actual de la salida 4
String outputState5 = "apagado"; //almacenar el estado actual de la salida 5
          ...
          if(currentLine.length() == 0)
          {
            ...
            if (header.indexOf("GET /x") >= 0) {
             ...
             ///// COMANDOS LED 4 ///////
              ...
              else if (header.indexOf("GET /offj") >= 0) {
              Serial.println("GPIO apagado");
