...
def botonesMainScreen(pygame, botones):
    ...
    log_boton_imagen = pygame.image.load("imagenes/BioMicroSystemsLinea2.jpeg")
    ...
    log_boton_imagen = pygame.transform.scale(log_boton_imagen, [int(tam_boton*1.8), int(tam_boton*0.6)])
    ...
    r_boton_confg.topleft = [top_left, top_up + boton_separacion*1.8]
    r_boton_on.topleft = [top_left, top_up + boton_separacion*2.7]
    r_boton_log.topleft = [510, 420]
...
def botonesSettingScreen(pygame, botonesConfig):
    ...
    log_boton_imagen = pygame.image.load('imagenes/BioMicroSystems.jpeg')

    # Se escalan las imagenes cargadas
    minTem_boton_imagen = pygame.transform.scale(minTem_boton_imagen, [int(widthBoton), int(heightBoton)])
    maxTem_boton_imagen = pygame.transform.scale(maxTem_boton_imagen, [int(widthBoton), int(heightBoton)])
    calibra_boton_imagen = pygame.transform.scale(calibra_boton_imagen, [int(widthBoton*1.3), int(heightBoton*1.3)])
    ...
    png_boton_imagen = pygame.transform.scale(png_boton_imagen, [int(widthBoton), int(heightBoton)])
    soc_boton_imagen = pygame.transform.scale(soc_boton_imagen, [int(widthBoton), int(heightBoton)])
    soc_boton_imagen2 = pygame.transform.scale(soc_boton_imagen, [int(widthBoton), int(heightBoton)])
    log_boton_imagen = pygame.transform.scale(log_boton_imagen, [int(widthBoton*3.5), int(heightBoton*3.5)])
    ...
    # Asignacion de posiciones
    r_boton_maxTem.topleft = posBotonEsquina(posMax, (int(widthBoton/2), int(heightBoton/2)))
    r_boton_minTem.topleft = posBotonEsquina(posMin, (int(widthBoton/2), int(heightBoton/2)))
    ...
    r_boton_log.topleft = posBotonEsquina(posLog, (widthBoton*3.5, heightBoton*3.5))
    ...
    botonesConfig.append(
        {'imagen': png_boton_imagen, 'rect': r_boton_png, 'selected': False, 'texto': [""], 'pos': posPng})
    botonesConfig.append(
        {'imagen': log_boton_imagen, 'rect': r_boton_log, 'selected': False, 'texto': [""], 'pos': posLog})
    botonesConfig.append(
        {'imagen': soc_boton_imagen, 'imagen_dos': soc_boton_imagen2,'rect': r_boton_soc, 'selected': False, 'texto': ["Servidor"], 'pos': posSoc})
...
def botonesLimScreen(pygame, botonesMaximo):
    ...
    botonesMaximo.append(
        {'imagen': mas_boton_imagen, 'rect': r_boton_mas2, 'selected': False, 'texto': [""], 'pos': posMas2})
    botonesMaximo.append(
        {'imagen': menos_boton_imagen, 'rect': r_boton_menos2, 'selected': False, 'texto': [""], 'pos': posMenos2})
    botonesMaximo.append(
        {'imagen': log_boton_imagen, 'rect': r_boton_log, 'selected': False, 'texto': [""], 'pos': posLog})
