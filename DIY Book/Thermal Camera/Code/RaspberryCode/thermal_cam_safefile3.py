...
def dibujar_botones_configuracion():
    ...
    textLabel = textFont_temp.render("Extension de archivo de datos: "+ extActual, True, NEGRO)
...
def botonesPantallaConfiguracion():
    global extActual, root, raiz, salirGrabacionCSV, grabarVideo, botones, configurar, salirMainScrn, confiMax, MAXTEMP, MINTEMP, confiMin, salir, confiCal
