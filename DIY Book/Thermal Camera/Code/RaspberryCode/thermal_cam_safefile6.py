...
def dibujar_botones_configuracion():
    ...
    #textLabel = textFont_temp.render('', True, NEGRO)
    #lcd.blit(textLabel, (470, 380))
    pygame.display.update()   
...
def botonesPantallaConfiguracion():
    global videoCon, extActual, extActual2, root, raiz, salirGrabacionCSV, grabarVideo, botones, configurar, salirMainScrn, confiMax, MAXTEMP, MINTEMP, confiMin, salir, confiCal
